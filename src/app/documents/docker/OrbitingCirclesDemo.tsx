...
export function OrbitingCirclesDemo() {
  return (
    <div className="relative flex h-[500px] w-full flex-col items-center justify-center overflow-hidden bg-transparent">
      <span className="pointer-events-none whitespace-pre-wrap bg-gradient-to-b from-black to-blue-700 bg-clip-text text-center text-8xl font-semibold leading-none text-transparent dark:to-blue-700 dark:from-white">
        Docker
      </span>
      <OrbitingCircles
        className="size-[68px] border-none bg-transparent p-1"
        radius={194}
        duration={20}
        delay={20}
        reverse
